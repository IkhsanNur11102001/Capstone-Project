...
import com.nur_ikhsan.themoviedb.data.response.RentItem
import com.nur_ikhsan.themoviedb.databinding.ItemProvidersDetailBinding

class ProvidersAdapterRent(private val providers : ProvidersUS) : RecyclerView.Adapter<ProvidersAdapterRent.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding : ItemProvidersDetailBinding) : RecyclerView.ViewHolder(binding.root) {
        fun setProviders(provider: RentItem) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val provider = providers.uS.rent[position]
        holder.setProviders(provider)
    }

    override fun getItemCount(): Int = providers.uS.rent.size
}