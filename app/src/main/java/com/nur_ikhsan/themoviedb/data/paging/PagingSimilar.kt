...
class PagingSimilar(private val apiInterface: ApiInterface, private val movieId : String) : PagingSource<Int, ResultMovie>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ResultMovie> {
        return try {
            ...
            val response = apiInterface.getSimilarMovie(movieId = movieId, page)
